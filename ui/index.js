  ...
  setup() {
    ...
    async function fetchMemoryData(sessionId) {
      try {
        ...
        const memoryLong = memoryStore.getLongTermMemory(sessionId);
        const memoryShort = memoryStore.getShortTermMemory(sessionId);
        const memoryLogs = memoryStore.getLogs(sessionId);
        const agentData = memoryStore.getAgent();
        ...
        <div :class="[
          ...
          >
            <div class="h-full overflow-y-auto relative">
              ...
              >
                {{ longTermMemory || '(Empty - Start chatting to build memory)' }}
              </div>
            </div>
          </BrainSection>
        </div>
